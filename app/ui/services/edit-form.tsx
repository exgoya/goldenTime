...
import { issue, EngineerField, CustomerField } from '@/app/lib/definitions';
import {
  BuildingOfficeIcon,
  CheckIcon,
  ClockIcon
...
export default function EditForm({
  ...
  issue : issue;
  engineers: EngineerField[], customers: CustomerField[]
}) {
  ...
  return (
    <form action={dispatch}>
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              defaultValue={issue.engineer_id}
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              name="customerId"
              className="peer block w-full cursor-pointer rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
              defaultValue={issue.customer_id}
            ...
            <div className="flex gap-4">
             <div className="flex items-center">
                <input
                  ...
                  defaultChecked={issue.status === 'feedback'}
                />
                <label
                  htmlFor="feedback"
              ...
              <div className="flex items-center">
                <input
                  ...
                  defaultChecked={issue.status === 'close'}
                />
                <label
                  htmlFor="close"
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit">Edit Issues</Button>
      </div>
    </form>
  );
}
